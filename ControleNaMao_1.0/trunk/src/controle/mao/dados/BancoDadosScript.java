...
//	};
	...
	// Cria a tabela com o "_id" sequencial
	private static final String[] SCRIPT_DATABASE_CREATE = new String[] {
		"CREATE TABLE [tb_cartoes] ( [_id] INTEGER PRIMARY KEY AUTOINCREMENT, [nome_cartao] CHAR(45) NOT NULL, [bandeira_Cartao] CHAR(45) NOT NULL, [fechaFatura_cartao] INTEGER(2) NOT NULL);",
		"CREATE TABLE [tb_categorias] ( [_id] INTEGER PRIMARY KEY AUTOINCREMENT, [nome_categoria] CHAR(45) NOT NULL);",
		"CREATE TABLE [tb_despesa] ( [_id] INTEGER PRIMARY KEY AUTOINCREMENT, [descricao] CHAR(45) NOT NULL, [id_categoria] INTEGER NOT NULL CONSTRAINT [_id] REFERENCES [tb_categorias]([_id]) ON DELETE NO ACTION ON UPDATE CASCADE, [tipo_cartao] CHAR(45) NOT NULL, [modalidade] CHAR(45) NOT NULL, [data_pagamento] DATE NOT NULL, [valor] FLOAT(8) NOT NULL, [parcelas] INTEGER(2), [periodo] CHAR(45), [id_cartao] INTEGER CONSTRAINT [_id] REFERENCES [tb_cartoes]([_id]) ON DELETE NO ACTION ON UPDATE CASCADE);",
		"CREATE TABLE [tb_recebimento] ( [_id] INTEGER PRIMARY KEY AUTOINCREMENT, [descricao] CHAR(45) NOT NULL, [id_categoria] INTEGER NOT NULL CONSTRAINT [_id] REFERENCES [tb_categorias]([_id]) ON DELETE NO ACTION ON UPDATE CASCADE, [valor] FLOAT(8) NOT NULL, [data_pagamento] DATE NOT NULL);",
		"CREATE TABLE [tb_controle] ( [_id] INTEGER PRIMARY KEY AUTOINCREMENT, [id_recebimento] INTEGER CONSTRAINT [_id] REFERENCES [tb_recebimento]([_id]) ON DELETE NO ACTION ON UPDATE NO ACTION, [id_despesa] INTEGER CONSTRAINT [_id] REFERENCES [tb_despesa]([_id]) ON DELETE NO ACTION ON UPDATE NO ACTION, [data_baixa] DATE, [valor] FLOAT(8));"
		};
